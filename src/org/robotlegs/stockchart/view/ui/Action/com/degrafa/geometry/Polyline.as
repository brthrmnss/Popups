package com.degrafa.geometry
{
    ...
    public class Polyline extends Geometry implements IGeometry
    {
        ...
        public function Polyline(param1:Array = null)
        {
            if (param1)
            {
                this.points = param1;
        ...
        {
            var _loc_2:* = this.autoClose;
            if (_loc_2 !== param1)
            {
                this._1635206537autoClose = param1;
                this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "autoClose", _loc_2, param1));
            }
            return;
        }// end function

        private function set _1635206537autoClose(param1:Boolean) : void
        {
            if (_autoClose != param1)
            {
                _autoClose = param1;
                invalidated = true;
            }
        ...
        public function set derive(param1:Polyline) : void
        {
            if (!fill)
            {
                fill = param1.fill;
