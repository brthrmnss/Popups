package com.brightPoint.skins
{
    ...
    public class ChartSlicerLeftMaskSkin extends GraphicBorderSkin implements IBindingClient
    {
        ...
        public var _ChartSlicerLeftMaskSkin_RoundedRectangle1:RoundedRectangle;
        var _bindings:Array;
        private var _1420394384emptyFill:SolidFill;
        private var _104h:Number;
        private static var _watcherSetupUtil:IWatcherSetupUtil;

        public function ChartSlicerLeftMaskSkin()
        {
            var target:ChartSlicerLeftMaskSkin;
            var watcherSetupUtilClass:Object;
            _bindings = [];
            _watchers = [];
            _bindingsByDestination = {};
            _bindingsBeginWithWord = {};
            this.strokes = [_ChartSlicerLeftMaskSkin_LinearGradientStroke1_i(), _ChartSlicerLeftMaskSkin_SolidStroke1_i(), _ChartSlicerLeftMaskSkin_SolidStroke2_i()];
            this.fills = [_ChartSlicerLeftMaskSkin_LinearGradientFill1_i(), _ChartSlicerLeftMaskSkin_SolidFill1_i()];
            this.geometry = [_ChartSlicerLeftMaskSkin_GeometryComposition1_i()];
            var bindings:* = _ChartSlicerLeftMaskSkin_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_com_brightPoint_skins_ChartSlicerLeftMaskSkinWatcherSetupUtil");
        ...
        private function _ChartSlicerLeftMaskSkin_SolidStroke1_i() : SolidStroke
        {
        ...
        private function _ChartSlicerLeftMaskSkin_RoundedRectangle1_i() : RoundedRectangle
        {
            var _loc_1:* = new RoundedRectangle();
            _ChartSlicerLeftMaskSkin_RoundedRectangle1 = _loc_1;
            _loc_1.x = 1;
            _loc_1.y = 1;
            _loc_1.cornerRadius = 0;
            BindingManager.executeBindings(this, "_ChartSlicerLeftMaskSkin_RoundedRectangle1", _ChartSlicerLeftMaskSkin_RoundedRectangle1);
            _loc_1.initialized(this, "_ChartSlicerLeftMaskSkin_RoundedRectangle1");
            return _loc_1;
        }// end function
        ...
        private function _ChartSlicerLeftMaskSkin_SolidFill1_i() : SolidFill
        {
        ...
        private function _ChartSlicerLeftMaskSkin_GradientStop4_c() : GradientStop
        {
        ...
        private function _ChartSlicerLeftMaskSkin_GradientStop2_c() : GradientStop
        {
            var _loc_1:* = new GradientStop();
        ...
        private function _ChartSlicerLeftMaskSkin_SolidStroke2_i() : SolidStroke
        {
            var _loc_1:* = new SolidStroke();
            lightStroke = _loc_1;
            _loc_1.color = 16777215;
        ...
        private function _ChartSlicerLeftMaskSkin_RoundedRectangle2_i() : RoundedRectangle
        {
            var _loc_1:* = new RoundedRectangle();
            myRect = _loc_1;
            _loc_1.cornerRadius = 0;
        ...
        private function _ChartSlicerLeftMaskSkin_bindingExprs() : void
        {
        ...
        private function _ChartSlicerLeftMaskSkin_GeometryComposition1_i() : GeometryComposition
        {
            var _loc_1:* = new GeometryComposition();
            myComp = _loc_1;
            _loc_1.geometry = [_ChartSlicerLeftMaskSkin_RoundedRectangle1_i(), _ChartSlicerLeftMaskSkin_RoundedRectangle2_i()];
        ...
        private function _ChartSlicerLeftMaskSkin_LinearGradientStroke1_i() : LinearGradientStroke
        {
            var _loc_1:* = new LinearGradientStroke();
            myStroke = _loc_1;
            _loc_1.weight = 1;
            _loc_1.angle = 90;
            _loc_1.gradientStops = [_ChartSlicerLeftMaskSkin_GradientStop1_c(), _ChartSlicerLeftMaskSkin_GradientStop2_c()];
        ...
        private function _ChartSlicerLeftMaskSkin_bindingsSetup() : Array
        {
            var binding:Binding;
            var result:Array;
            ...
            {
                _ChartSlicerLeftMaskSkin_RoundedRectangle1.width = param1;
                return;
            }// end function
            , "_ChartSlicerLeftMaskSkin_RoundedRectangle1.width");
            result[0] = binding;
            binding = new Binding(this, function () : Number
            {
                return h - 2;
            ...
            , function (param1:Number) : void
            {
                _ChartSlicerLeftMaskSkin_RoundedRectangle1.height = param1;
                return;
            }// end function
            , "_ChartSlicerLeftMaskSkin_RoundedRectangle1.height");
            result[1] = binding;
            ...
            {
                _ChartSlicerLeftMaskSkin_RoundedRectangle1.stroke = param1;
                return;
            }// end function
            , "_ChartSlicerLeftMaskSkin_RoundedRectangle1.stroke");
            result[2] = binding;
            binding = new Binding(this, function () : IGraphicsStroke
            {
                return darkStroke;
        ...
        private function _ChartSlicerLeftMaskSkin_LinearGradientFill1_i() : LinearGradientFill
        {
            var _loc_1:* = new LinearGradientFill();
            darkFill = _loc_1;
            _loc_1.angle = 90;
            _loc_1.gradientStops = [_ChartSlicerLeftMaskSkin_GradientStop3_c(), _ChartSlicerLeftMaskSkin_GradientStop4_c(), _ChartSlicerLeftMaskSkin_GradientStop5_c()];
            _loc_1.initialized(this, "darkFill");
            return _loc_1;
        }// end function

        private function _ChartSlicerLeftMaskSkin_GradientStop3_c() : GradientStop
        {
            var _loc_1:* = new GradientStop();
            _loc_1.color = 16777215;
            _loc_1.ratio = 0;
        ...
        private function _ChartSlicerLeftMaskSkin_GradientStop5_c() : GradientStop
        {
            var _loc_1:* = new GradientStop();
            _loc_1.color = 0;
            _loc_1.ratio = 1;
        ...
        private function _ChartSlicerLeftMaskSkin_GradientStop1_c() : GradientStop
        {
            var _loc_1:* = new GradientStop();
            _loc_1.color = 0;
            _loc_1.alpha = 0.4;
        ...
        {
            ChartSlicerLeftMaskSkin._watcherSetupUtil = param1;
            return;
        }// end function
