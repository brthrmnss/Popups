								...
								implements IDataRenderer
{
	...
	public function set data(value:Object):void
	{
		if (_chartItem == value)
			return;
		var ee : MouseEvent
		value.addEventListener( MouseEvent.MOUSE_OVER, mouseOver,  false, 0, true ) 
		_chartItem = value;
	}
												  ...
												  unscaledHeight:Number):void
	{
       ...
       // var arr : Array = [this.mouseX, this.mouseY, this.stage.mouseX, 
		//	this.stage.mouseY, this.parent, this.data.x, this.data.y]
			//if i'm here it 
